    ...
    return (
        <Card sx={{ minWidth: 275, mb: 3, mt: 3, bgcolor: palette.primary.white }}>
            ...
            <CardContent>
                ...
                <Typography variant='h5' component= "div">{jobTitle}</Typography>
                <Typography sx={{mb: 1.5 }} color= "text.secondary">{category}</Typography>
                <Typography variant='body2'>Description: {description.split(" ").slice(0, 15).join(" ")+ "..."}</Typography>
